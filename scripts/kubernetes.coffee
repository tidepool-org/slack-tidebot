...
module.exports = (robot) ->
    ...
    robot.router.post '/hubot/gh-repo-events', (req, res) ->
        ...
        github.get branches, (branch) ->
            ...
            console.log "PROCESS.ENV: " + JSON.stringify(process.env.inputToEnvironmentMap[5])
            console.log "PROCESS.ENV service: " + JSON.stringify(process.env.inputToRepoMap["map"].prd)
